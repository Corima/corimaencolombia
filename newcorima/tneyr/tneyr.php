...
<div id="main">
  <table class="banner">
    <tr>
      <td class="logo"><object 
	data="../swf/corimita.swf" 
...
<div align="center">
  ...
  <table align="center" class="tabla_base">
    <!--DWLayoutTable-->
    <tr>
      <td><div align="center"><a href="metodo_nombre.html">Quieres Otra Consulta ???<br />
...
<input type="button" onclick="pasarDatos();" id="redibujar" value="redibujar estrella" /><br />
 ...
 <div align="center">Los respectivos n&uacute;meros se obtiene remplazando <br />
   las letras por los valores de la tabla de abajo.<br />
 </div>
 ...
 <table width="463" align="center" class="tabla_base_warm">
   ...
   <br />
   <table align="center" class="tabla_base_green">

      <caption>Significado del N&uacute;mero personal</caption>

    
      <tr bgcolor="<?php if($nom->sumLetras==1){echo "#FFFFCC";} ?>">
      <td>1</td>
    ...
    <tr bgcolor="<?php if($nom->sumLetras==2){echo "#FFFFCC";} ?>">
      <td>2</td>
    ...
    <tr bgcolor="<?php if($nom->sumLetras==6){echo "#FFFFCC";} ?>">
      <td>6</td>
    ...
    <tr bgcolor="<?php if($nom->sumLetras==7){echo "#FFFFCC";} ?>">
      <td>7</td>
    ...
    <tr bgcolor="<?php if($nom->sumLetras==8){echo "#FFFFCC";} ?>">
      <td>8</td>
    ...
    <tr bgcolor="<?php if($nom->sumLetras==9){echo "#FFFFCC";} ?>">
      <td>9</td>
   ...
    
   <table align="center" class="tabla_base_wood">

      <caption>Significado del N&uacute;mero de Misi&oacute;n y S&iacute;mbolos</caption>


    <tr bgcolor="<?php if($nMision->sumaNum==1){echo "#FFFFCC";} ?>">
      <td>1</td>
	...
	<tr bgcolor="<?php if($nMision->sumaNum==2){echo "#FFFFCC";} ?>">
      <td>2</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==3){echo "#FFFFCC";} ?>">
      <td>3</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==4){echo "#FFFFCC";} ?>">
      <td>4</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==5){echo "#FFFFCC";} ?>">
      <td>5</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==6){echo "#FFFFCC";} ?>">
      <td>6</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==7){echo "#FFFFCC";} ?>">
      <td>7</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==8){echo "#FFFFCC";} ?>">
      <td>8</td>
    ...
    <tr bgcolor="<?php if($nMision->sumaNum==9){echo "#FFFFCC";} ?>">
      <td>9</td>
...
setTimeout("rec.click()",500);
  ...
  <div id="pie">
    <div id="infomail">Responsable del WEB site <a href="mailto:danielsilva25@hotmail.com" >Daniel Silva</a> </div>
    <div id="google">
<form action="http://www.google.com/cse" id="cse-search-box">
  <div>
    <input type="hidden" name="cx" value="014260501083511125448:pkmvy22jrbq" />
